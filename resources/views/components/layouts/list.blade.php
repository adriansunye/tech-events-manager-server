<main class="grid w-full gap-4 lg:gap-x-32 px-6 md:px-16 pb-24">
    @foreach ($events as $event)
        <div id="app"
            href="{{ route('events.show', $event) }}"class="bg-white  border rounded-lg shadow-md flex card text-grey-darkest">
            ...
            <div class=" flex flex-1 flex-col ">
                <div class="p-3 pb-0 sm:flex flex-1 gap-7 flex-row  justify-start">
                    <div class="flex flex-col">
                        ...
                        <span class=" text-emerald-400">{{ $event->max_participants }} places lliures</span>
                            ...
                            @can('delete events')
                                <form action="{{ route('events.destroy', $event) }}" method="POST">
                                    ...
                                    <button
                                        ...
                                        type="submit"><svg width="20" height="20" fill="none"
                ...
                <div class=" ml-14 sm:ml-48 md:ml-56 lg:ml-72 flex flex-col">
                    <a href="{{ route('events.show', $event) }}"
                        class=" bg-emerald-200 rounded-br-lg rounded-tl-lg">
                        <div class="p-1 mr-2 flex items-center  justify-end transition hover:bg-grey-light">
                            Apuntar-s'hi

<x-layouts.app title="User" meta-description="User meta desription">
  ...
  <div class="min-h-[50%]">
    ...
    <div class="p-14">
      ...
      <a href="{{ route('events.show', $event) }}" class="flex  items-center bg-white border rounded-3xl  hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700 my-8 bg-white  rounded-lg shadow-md">
